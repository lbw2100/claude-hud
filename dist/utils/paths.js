...
/**
 * Get the plugin cache base directory for claude-code-hud-plugin.
 * This is the directory containing version subdirectories.
 *
 * Structure: <configDir>/plugins/cache/hud/claude-code-hud-plugin/
 */
export function getPluginCacheBase() {
    return join(getClaudeConfigDir(), 'plugins', 'cache', 'hud', 'claude-code-hud-plugin');
}
/**
